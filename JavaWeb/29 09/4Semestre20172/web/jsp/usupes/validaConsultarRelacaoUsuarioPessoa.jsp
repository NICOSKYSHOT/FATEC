        ...
        <table class="striped responsive-table">
            <thead>
              <tr>
                  ...
                  <th data-field="NomePessoa">NomeUsuario</th>
                    ...
                    <% for (UsuarioPessoa listaUsuarioPessoa : usupess) { %>
                        <tr>
                            ...
                            <% if (usuLogado.getTipo().equals("ADM")) { %>
                                <td><a href="excluirRelacaoUsuarioPessoa.jsp?COD=<%=listaUsuarioPessoa.getIdUsuPes()%>">Excluir</a></td>
                                <td><a href="alterarRelacaoUsuarioPessoa.jsp?COD=<%=listaUsuarioPessoa.getIdUsuPes()%>">Alterar</a></td>
                            <% } %>
                        </tr>
                    <% } %>
                </tbody>
